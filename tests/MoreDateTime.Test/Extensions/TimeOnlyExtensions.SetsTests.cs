namespace MoreDateTime.Tests.Extensions
{
	...
	{
		private readonly TimeOnly _startDate1 = new TimeOnly(10, 01, 01);
		private readonly TimeOnly _endDate1   = new TimeOnly(10, 01, 10);
		private readonly TimeOnly _startDate2 = new TimeOnly(10, 01, 05);
		private readonly TimeOnly _endDate2   = new TimeOnly(10, 01, 20);
		private readonly TimeOnly _startDate3 = new TimeOnly(10, 02, 01);
		private readonly TimeOnly _endDate3   = new TimeOnly(10, 02, 10);
		...
		{
			// Arrange
			var a = new TimeOnlyRange(_startDate1, _endDate1);
			var b = new TimeOnlyRange(_startDate2, _endDate2);
			var c = new TimeOnlyRange(_startDate3, _endDate3);
		...
		{
			Should.Throw<ArgumentNullException>(() => default(TimeOnlyRange)!.Union(new TimeOnlyRange()));
		}
		...
		{
			Should.Throw<ArgumentNullException>(() => new TimeOnlyRange().Union(default(TimeOnlyRange)!));
		}
		...
		{
			Should.Throw<ArgumentNullException>(() => default(TimeOnlyRange)!.Intersection(new TimeOnlyRange()));
		}
		...
		{
			Should.Throw<ArgumentNullException>(() => new TimeOnlyRange().Intersection(default(TimeOnlyRange)!));
		}
		...
		{
			Should.Throw<ArgumentNullException>(() => default(TimeOnlyRange)!.Difference(new TimeOnlyRange()));
		}
		...
		{
			Should.Throw<ArgumentNullException>(() => new TimeOnlyRange().Difference(default(TimeOnlyRange)!));
		}
		...
		{
			Should.Throw<NullReferenceException>(() => default(TimeOnlyRange)!.DoesOverlap(new TimeOnlyRange()));
		}
		...
		{
			Should.Throw<NullReferenceException>(() => new TimeOnlyRange().DoesOverlap(default(TimeOnlyRange)!));
		}
	}
}